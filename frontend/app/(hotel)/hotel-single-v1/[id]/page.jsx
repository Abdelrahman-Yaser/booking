...
export const metadata = {
  ...
  description: "Explore hotel details, amenities, reviews and book your perfect accommodation with Flymefy.",
  keywords: "hotel details, hotel booking, hotel reviews, accommodation",
};

const HotelSingleV1 = ({ params }) => {
  const id = params.id;
