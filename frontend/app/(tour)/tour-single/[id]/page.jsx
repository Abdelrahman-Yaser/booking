...
export const metadata = {
  ...
  description: "Explore tour details, itinerary, reviews and book your perfect tour experience with Flymefy.",
  keywords: "tour details, tour booking, tour packages, travel tours, sightseeing",
};

const TourSingle = ({ params }) => {
  const id = params.id;
