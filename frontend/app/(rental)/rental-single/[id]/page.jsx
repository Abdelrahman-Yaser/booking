...
export const metadata = {
  ...
  description: "Explore rental details, amenities, reviews and book your perfect rental property with Flymefy.",
  keywords: "rental details, property rental, vacation rental, accommodation booking",
};

const RentalSingle = ({ params }) => {
  const id = params.id;
