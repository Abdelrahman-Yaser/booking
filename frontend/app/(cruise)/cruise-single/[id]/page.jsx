...
export const metadata = {
  ...
  description: "Explore cruise details, amenities, reviews and book your perfect cruise experience with Flymefy.",
  keywords: "cruise details, cruise booking, cruise packages, ocean travel, cruise vacation",
};

const CruiseSingle = ({ params }) => {
  const id = params.id;
