...
export const metadata = {
  ...
  description: "Explore activity details, information, reviews and book your perfect activity experience with Flymefy.",
  keywords: "activity details, activity booking, tours, activities, travel experiences",
};

const ActivitySingle = ({ params }) => {
  const id = params.id;
  const activity =
