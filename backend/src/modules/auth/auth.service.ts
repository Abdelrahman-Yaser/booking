...
export class AuthService {
  ...
  private omitPasswords(users: User[]): SafeUser[] {
...
// ─── REGISTER ────────────────────────────────────────────────────────────────
  async create(
    ...
    try {
      // 1. إنشاء كائن المستخدم مع عمل cast صريح كـ any لمنع الـ Overload البديل لـ TypeORM
      ...
      // 2. تمرير الكائن للـ save وعمل كاستينج مباشر للمخرج كـ User
